...
public class TestHighloadWalletV3 extends CommonTest {
    ...
    public void testBulkTransferSimplified_2_SignedExternally() throws Exception {
        ...
        byte[] signedDeployBody = Utils.signData(keyPair.getPublicKey(), keyPair.getSecretKey(), deployBody.hash());
    ...
    public void testTransfer_200_CustomCell() throws InterruptedException, NoSuchAlgorithmException {
        ...
        // top up new wallet using test-faucet-wallet
        BigInteger balance = TestnetFaucet.topUpContract(tonlib, Address.of(nonBounceableAddress), Utils.toNano(3));
    ...
    public void testBulkJettonTransfer() throws InterruptedException {
        ...
        HighloadWalletV3 myHighLoadWalletV3 = HighloadWalletV3.builder().tonProvider(tonlib).keyPair(keyPair).walletId(42).build();
        ...
        balance = TestnetJettonFaucet.topUpContractWithNeoj(
                tonlib, Address.of(nonBounceableAddress), BigInteger.valueOf(100));
        log.info("new wallet {} jetton balance: {}",
                myHighLoadWalletV3.getName(),
        ...
        config = HighloadV3Config.builder()
                ...
                .body(myHighLoadWalletV3.createBulkTransfer(
                        Collections.singletonList(Destination.builder()
    ...
    public void testBulkJettonTransferTonCenter() throws Exception {
        ...
        HighloadWalletV3 myHighLoadWalletV3 =
                HighloadWalletV3.builder().tonProvider(tonCenter).keyPair(keyPair).walletId(42).build();
