...
public class TestDns extends CommonTest {
    ...
    public void testDnsResolveTestnetAdnlLiteClient() throws Exception {
        AdnlLiteClient adnlLiteClient = AdnlLiteClient.builder()
    ...
    @Test
    public void testDnsResolveMainnetTonCenterClient() {
    ...
    @Test
    public void testDnsCollectionItemDeploy() {
        ...
        SendResponse sendResponse = adminWallet.send(adminWalletConfig);
        assertThat(sendResponse.getCode()).isZero();
        dnsCollection.waitForDeployment();
        ...
        Address dnsItem1Address = DnsCollection.getNftItemAddressByDomain(
        ...
        assertThat(sendResponse.getCode()).isZero();
        buyerWallet.waitForBalanceChange();
        ...
        assertThat(sendResponse.getCode()).isZero();
        Utils.sleep(6, "Claim DNS item " + dnsItem1DomainName);
        ...
        assertThat(sendResponse.getCode()).isZero();
        Utils.sleep(6, "Assign wallet to domain " + dnsItem1DomainName);
        ...
        assertThat(sendResponse.getCode()).isZero();
        Utils.sleep(6, "govern dns item");

        sendResponse = transferDnsItem(buyerWallet, dnsItem1Address, "EQBCMRzsJBTMDqF5JW8Mbq9Ap7b88qKxkwktlZEChtLbiFIH");
        assertThat(sendResponse.getCode()).isZero();
        Utils.sleep(6, "transferring domain to other user");
        ...
        sendResponse = releaseDnsItem(buyerWallet, dnsItem1Address, Utils.toNano(15)); // will fail with error code 414
        assertThat(sendResponse.getCode()).isZero();
        Utils.sleep(6);
    ...
    @Test
    public void testDnsCollectionItemDeployTonCenter() {
        ...
        Address dnsItem1Address = DnsCollection.getNftItemAddressByDomain(tonCenter, dnsCollection.getAddress(), dnsItem1DomainName);
        log.info("dnsItem1 address {}", dnsItem1Address);

        tonCenter.waitForDeployment(dnsItem1Address);
        //        ContractUtils.waitForDeployment(tonlib, dnsItem1Address, 60);
    ...
    public void testDnsItemDeployAtGlobalCollection() throws InterruptedException {
        ...
        SendResponse sendResponse = adminWallet.send(adminWalletConfig);
        assertThat(sendResponse.getCode()).isZero();
        Utils.sleep(6, "deploying DNS item " + dnsItem1DomainName);
        ...
        // assign your wallet to a domain name
    ...
    private static void resolveDnsCollectionItems(Address dnsCollectionAddress) {
        ...
        Address appleAddress = (Address)
                DnsCollection.resolve(tonlib, dnsCollectionAddress, "apple", DNS_CATEGORY_NEXT_RESOLVER, true);
        log.info("apple resolved to {}", appleAddress.toString(true, true, true));

        Address alice3Resolved = (Address)
                DnsCollection.resolve(tonlib,
    ...
    private SendResponse changeDnsRecord(
        ...
        Cell body = DnsItem.createChangeContentEntryBody(DNS_CATEGORY_WALLET, DnsUtils.createSmartContractAddressRecord(newSmartContract), 0);
    ...
    private SendResponse transferDnsItem(
        ...
        WalletV3Config ownerWalletConfig = WalletV3Config.builder()
                ...
                .destination(dnsItemAddress)
                .amount(Utils.toNano(0.07))
                .body(DnsItem.createTransferBody(
                        0,
                        Address.of(newOwner),
                        Utils.toNano(0.02),
                        "gift".getBytes(),
