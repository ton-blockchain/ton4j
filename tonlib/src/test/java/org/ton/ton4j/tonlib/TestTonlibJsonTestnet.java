...
public class TestTonlibJsonTestnet {
    ...
    static String tonlibPath = "/home/neodix/gitProjects/ton4j/tonlib/libtonlibjson-testnet.so";
    static Tonlib tonlib;
//  @BeforeAll
//  static void tearBeforeAll() throws Exception {
//
//    tonlib = Tonlib.builder().pathToTonlibSharedLib(tonlibPath).testnet(true).build();
//  }
//
//  @AfterAll
...
//  }
    ...
    public void testTonlibGetBlockTransactions() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Utils.sleep(1, "wait for next block");
        }
        tonlib.destroy();
    }
    ...
    public void testTonlibGetTxsByAddressTestnet() {
        ...
        assertThat(rawTransactions.getTransactions().size()).isNotZero();
        log.info("total txs: {}", rawTransactions.getTransactions().size());
    ...
    public void testTonlibGetConfigSingle() {
        Tonlib tonlib = Tonlib.builder().pathToTonlibSharedLib(tonlibPath).testnet(true).build();
        ConfigParams12 c = tonlib.getConfigParam12();
        log.info("config12 {}", c);
        assertThat(c).isNotNull();
    }
    ...
    public void testTonlibGetConfigs() {
        ...
        assertThat(tonlib.getConfigParam82()).isNotNull();
